...
In fact, most of the <RoughNotation>projects</RoughNotation> on this site will require cloud interaction of some sort—particularly with AWS's serverless products.

## Getting Started

> To use AWS in these projects, we'll need to set up an <RoughNotation type="highlight" color="pink">account</RoughNotation>, the CLI, and the SDK.
</RoughNotationGroup>
...
This is an image which is lazily loaded when it comes in viewport:

<Image src="/images/wolfhunter_title.png" alt="Description" width={600} height={400} caption="hello from caption of this image" />